...
const VERDICT_CONFIG: Record<
  ScanVerdict,
  { labelKey: string; color: string; bg: string; icon: typeof ShieldCheck }
> = {
  phishing: {
    labelKey: "scan.phishing",
    color: "text-red-400",
    bg: "bg-red-500/10 border-red-500/30",
    icon: AlertTriangle,
  },
  likely_phishing: {
    labelKey: "scan.likelyPhishing",
    color: "text-orange-400",
    bg: "bg-orange-500/10 border-orange-500/30",
    icon: ShieldAlert,
  },
  suspicious: {
    labelKey: "scan.suspicious",
    color: "text-yellow-400",
    bg: "bg-yellow-500/10 border-yellow-500/30",
    icon: HelpCircle,
  },
  likely_legitimate: {
    labelKey: "scan.likelyLegitimate",
    color: "text-emerald-400",
    bg: "bg-emerald-500/10 border-emerald-500/30",
    icon: ShieldCheck,
  },
  legitimate: {
    labelKey: "scan.legitimate",
