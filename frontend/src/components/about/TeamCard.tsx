    ...
    <>
      ...
      >
        ...
        <div className="z-10 text-xs font-bold tracking-widest uppercase flex items-center mt-2 group-hover:text-cyan-400 transition-colors duration-300 bg-background/50 px-4 py-2 rounded-full border border-border/50 group-hover:border-cyan-500/30">
          {LOCALE.about.teamCard.viewProfile} <ChevronRight size={14} className="ml-1 group-hover:translate-x-1 transition-transform" />
        </div>
      </motion.div>
                ...
                <div className="mt-8 space-y-6 text-left">
                  {member.bio && (
                    <div className="space-y-2">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground border-b border-border/50 pb-2">{LOCALE.about.teamCard.about}</h4>
                  ...
                  {member.contributions && member.contributions.length > 0 && (
                    <div className="space-y-2">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground border-b border-border/50 pb-2">{LOCALE.about.teamCard.contributions}</h4>
                  ...
                  {member.skills && member.skills.length > 0 && (
                    <div className="space-y-2">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground border-b border-border/50 pb-2">{LOCALE.about.teamCard.techStack}</h4>
