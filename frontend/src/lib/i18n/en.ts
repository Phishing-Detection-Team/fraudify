...
const en = {
  ...
  about: {
    ...
    teamCard: {
      ...
      about: "About",
      contributions: "Sentra Contributions",
    ...
    members: {
      quy: {
        ...
        contrib1Label: "Browser Defense",
        contrib1Desc: "Built a DOM-level interception system that catches and disables hidden HTML payloads before they can trick the AI.",
        contrib2Label: "AI Safety & Training",
        contrib2Desc: "Pen-tested the LLM with prompt-injection attacks and hardened it to eliminate exploitable vulnerabilities.",
        contrib3Label: "Threat Intelligence",
        contrib3Desc: "Integrated the VirusTotal API to cross-check suspicious links against 70+ active antivirus scanners in real-time.",
      },
      hoang: {
        ...
        contrib1Label: "Backend Architecture",
        contrib1Desc: "Architected the scalable FastAPI backend infrastructure to handle high-volume real-time requests.",
        contrib2Label: "Caching Strategy",
        contrib2Desc: "Implemented the Redis caching layer to reduce scan latency by 40%.",
        contrib3Label: "AI Orchestration",
        contrib3Desc: "Designed the AI agentic orchestration logic for browser extensions.",
      },
      bao: {
        ...
        contrib1: "Integrated secure authentication and OAuth pipelines.",
        contrib2: "Developed the rate-limiting and anti-abuse mechanisms.",
        contrib3: "Pioneered the browser extension integration with the Sentra backend via WebSockets.",
      },
      thanh: {
        ...
        contrib1: "Built the modern Next.js dashboard and analytic views.",
        contrib2: "Implemented the Sentra design system and Framer Motion animations.",
        contrib3: "Constructed the secure Chrome Extension UI and popup logic.",
      },
    },
  ...
  feed: {
    ...
    noInstancesAdmin: "No extension instances registered yet",
    noInstancesAdminHint: "Users can register instances from their Profile Settings page.",
    colUser: "User",
    colBrowser: "Browser",
    colOS: "OS",
